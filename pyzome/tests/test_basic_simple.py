...
from pyzome.testing import create_dummy_geo_field, lon_coord, lat_coord, plev_coord

# write tests for basic.py using pytest
# test_zonal_mean
# test_meridional_mean
# test_zonal_wave_coeffs
# test_zonal_wave_ampl_phase
# test_zonal_wave_contributions
# test_zonal_wave_covariance
